...
export default async function Page(props) {
  const [mode, sortByUpdated, sortOldestFirst, filter, query] = await FetchBlogParams(props.searchParams);
  ...
  return (
    <div className="my-8">
      <section>
        ...
        <br/>
        {DisplayBlogLinks(mode, sortByUpdated, sortOldestFirst, filter, query)}
      </section>
    </div>
  )
}
