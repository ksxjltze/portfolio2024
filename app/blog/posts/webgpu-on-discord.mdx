...
## Rust
Rust was painful, mainly because I decided to try and write my own implementation with a little reference to [tutorials](https://sotrh.github.io/learn-wgpu/), with little Rust experience, especially when dealing with explicit lifetimes and async programming.
