...
# Idea 6: Doro Game
I have the sudden urge to make a game about Dororong. Maybe it'll be like Holocure or Vampire Survivors, or maybe it'll be an idle game, or maybe it'll be like a hub world where doros just hang out and play minigames.

# Idea 7: Start a Doro-related youtube channel
I will spread the word of Doro far and wide, so that all may embrace it.

# Idea 8: Doro Tower
So there's this game jam: [Coco Code Game Jam](https://itch.io/jam/coco-code-gamejam-2).
The theme is "Tower", and it's got me thinking about making a simple doro game, with combat kinda like MapleStory, but you're a doro and you're climbing a tower.

# Idea 9: Discord Telemetry Webhook
Recently, I've been working on recording telemetry for a studio project (Balaspire), which we intend to use to glean insights from playtest data.

An idea that randomly popped up is to send every instance of data to a discord channel. It will be noisy, but I think it'd be cool to see how many people are actually playing our game demo in real-time.