...
Here's my scuffed attempt at trying to make a windows-vista-like window, I tried using CSS filters like blur, drop-shadow, and more linear gradients to achieve a glossy-ish look, but its far from satisfactory.
