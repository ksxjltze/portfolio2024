...
## Examples
Here's an example post that's highly relevant to my industry, the release of the Discord Social SDK:

![Discord Social SDK](/images/about-linked-in/discord-sdk-news.png)

<div className="mt-6">Here's another example about an expert sharing VFX tips and tricks:</div>

![Game Art Tricks](/images/about-linked-in/game-art-tricks.png)